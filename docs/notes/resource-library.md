...
- Books, courses, and videos all share the same tables; `Kind` says which.
...
|---|---|---|---|---|---|
| Intro to HTML/CSS | Khan Academy | Course | https://www.khanacademy.org/computing/computer-programming/html-css | in progress | `html/khan-academy-intro-html-css.md` |
...
## Delivery (Git / GitHub / Deployment)
